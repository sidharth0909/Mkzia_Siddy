...
app = FastAPI(
    ...
    description="Predicts housing price class: LOW / MEDIUM / HIGH",
    version="1.0.0",
)
...
def root():
    return {
        "message": "Housing Price Classification API is running",
